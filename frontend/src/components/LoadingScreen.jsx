...
export default function LoadingScreen({ idea }) {
  ...
  return (
    <div style={{
      ...
      padding: isMobile ? "1.5rem 1rem" : "2rem", position:"relative", overflow:"hidden",
    }}>
      ...
      {/* 3D Orbital spinner */}
      <div style={{ position:"relative", width:isMobile ? 120 : 160, height:isMobile ? 120 : 160, marginBottom:"2rem", flexShrink:0 }}>
        <div style={{
          position:"absolute", top:"50%", left:"50%",
          transform:"translate(-50%,-50%)",
          width:isMobile ? 46 : 60, height:isMobile ? 46 : 60, borderRadius:"50%",
          background:"linear-gradient(135deg,#6366f1,#8b5cf6)",
          boxShadow:"0 0 40px rgba(99,102,241,0.6)",
          animation:"pulse3d 2s ease-in-out infinite",
          display:"flex", alignItems:"center", justifyContent:"center",
          fontSize:isMobile ? "1.1rem" : "1.4rem", zIndex:2,
        }}>✦</div>
        ...
        {[0,1,2].map(i => (
          <div key={i} style={{
            position:"absolute", top:"50%", left:"50%",
            transform:"translate(-50%,-50%)",
            width: (isMobile ? 60 : 80) + i*30, height: (isMobile ? 60 : 80) + i*30,
            borderRadius:"50%",
      ...
      <motion.h2
        ...
        style={{ color:"#f1f5f9", fontSize: isMobile ? "1.3rem" : "1.6rem", fontWeight:800,
          marginBottom:"0.5rem", letterSpacing:"-0.02em", textAlign:"center" }}
      >
        Analyzing Your Idea{dots}
      </motion.h2>

      <p style={{
        color:"#475569", fontSize:isMobile ? "0.82rem" : "0.9rem", marginBottom:"2rem",
        textAlign:"center", maxWidth:isMobile ? "100%" : 460, lineHeight:1.6,
        padding:"0 0.5rem",
      }}>
        "{idea}"
      </p>
          ...
          return (
            <motion.div key={i}
              ...
              style={{
                ...
                borderRadius:12, padding: isMobile ? "0.7rem 0.85rem" : "0.85rem 1.1rem",
            ...
            >
              ...
              <div style={{ flex:1, minWidth:0 }}>
                <div style={{ color: done ? "#10b981" : active ? "#f1f5f9" : "#374151", fontWeight:600, fontSize: isMobile ? "0.8rem" : "0.88rem", whiteSpace: isMobile ? "nowrap" : "normal", overflow:"hidden", textOverflow:"ellipsis" }}>
                  {step.label}
                </div>
                {active && (
